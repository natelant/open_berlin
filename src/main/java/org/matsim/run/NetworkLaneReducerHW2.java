...
public class NetworkLaneReducerHW2 {
    public static void main(String[] args) {
        ...
        String output = "scenarios/equil/network-reduced-lanes-HW2.xml.gz";
        ...
        File file = new File("./scenarios/berlin-v5.5-1pct/Links-Leipziger-Strasse.txt");
